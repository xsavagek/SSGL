...
np.savetxt('results/bidirectional-lstm/MSFTclose/arr_true_close.csv', arr_true_close, delimiter = ',')
np.savetxt('results/bidirectional-lstm/MSFTclose/arr_pre_close.csv', arr_pre_close, delimiter = ',')
...
np.savetxt('results/bidirectional-lstm/MSFTclose/indicator.csv', indicator, delimiter = ',')
