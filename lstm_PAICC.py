...
np.savetxt('results/lstm/PAICC/arr_true_close.csv', arr_true_close, delimiter = ',')
np.savetxt('results/lstm/PAICC/arr_pre_close.csv', arr_pre_close, delimiter = ',')
...
np.savetxt('results/lstm/PAICC/indicator.csv', indicator, delimiter = ',')
