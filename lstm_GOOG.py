...
np.savetxt('results/lstm/GOOG/arr_true_close.csv', arr_true_close, delimiter = ',')
np.savetxt('results/lstm/GOOG/arr_pre_close.csv', arr_pre_close, delimiter = ',')
...
np.savetxt('results/lstm/GOOG/indicator.csv', indicator, delimiter = ',')