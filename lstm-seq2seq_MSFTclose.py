...
df = pd.read_csv('./dataset/MSFTclose.csv')
...
np.savetxt('results/lstm-seq2seq/MSFTclose/arr_true_close.csv', arr_true_close, delimiter = ',')
np.savetxt('results/lstm-seq2seq/MSFTclose/arr_pre_close.csv', arr_pre_close, delimiter = ',')
...
np.savetxt('results/lstm-seq2seq/MSFTclose/indicator.csv', indicator, delimiter = ',')
