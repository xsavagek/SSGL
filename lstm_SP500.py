...
np.savetxt('results/lstm/SP500/arr_true_close.csv', arr_true_close, delimiter = ',')
np.savetxt('results/lstm/SP500/arr_pre_close.csv', arr_pre_close, delimiter = ',')
...
np.savetxt('results/lstm/SP500/indicator.csv', indicator, delimiter = ',')
