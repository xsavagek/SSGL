...
np.savetxt('results/lstm-seq2seq/GOOG/arr_true_close.csv', arr_true_close, delimiter = ',')
np.savetxt('results/lstm-seq2seq/GOOG/arr_pre_close.csv', arr_pre_close, delimiter = ',')
...
np.savetxt('results/lstm-seq2seq/GOOG/indicator.csv', indicator, delimiter = ',')
