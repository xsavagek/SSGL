...
np.savetxt('results/lstm/MSFT/arr_true_close.csv', arr_true_close, delimiter = ',')
np.savetxt('results/lstm/MSFT/arr_pre_close.csv', arr_pre_close, delimiter = ',')
...
np.savetxt('results/lstm/MSFT/indicator.csv', indicator, delimiter = ',')